...
const multiply = (num1, num2, callbackName) => callbackName(num1 * num2);
// const product = (num1, num2) => num1 * num2;

// console.log(multiply(4, 7, product));
...
const last = (array, callbackFunc) => callbackFunc(array[array.length - 1]);
...
const contains = (arr, nameHere, callback) => {
  if (arr.includes(nameHere)) {
    callback(true);
  } else {
    callback(false);
  }
